...
describe('RingCentralHelpers.Message', function() {
    ...
    var Message = helpers.getMessage();
    ...
    describe('getAttachmentUrl & getAttachmentContentType', function() {
        ...
        it('gives a wrapped donwloadable url, empty string if not found', function() {
            ...
            expect(Message.getAttachmentUrl(message, 0)).to.equal('http://whatever/restapi/v1.0/account/~/extension/~/message-store/1/attachment/---1---?_method=GET&access_token=');
            expect(Message.getAttachmentUrl(message, 1)).to.equal('http://whatever/restapi/v1.0/account/~/extension/~/message-store/1/attachment/---2---?_method=GET&access_token=');
